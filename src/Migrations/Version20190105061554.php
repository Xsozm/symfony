 ...
 */
final class Version20190105061554 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64971179CD6 FOREIGN KEY (name_id) REFERENCES `group` (id)');
        $this->addSql('CREATE INDEX IDX_8D93D64971179CD6 ON user (name_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D64971179CD6 ON user');
